...
def salva_pdf_su_drive(dati, drive_service):
    """Crea un PDF in memoria e lo carica su Google Drive"""
    buffer = io.BytesIO()
    ...
    if request.method == "POST":
        ...
        if azione == "start":
            ...
            sheets_service.spreadsheets().values().append(
                ...
                valueInputOption="RAW", body={'values': [[c['data_p'], c['data_a'], c['autista'], c['targa'], c['partenza'], c['destinazione'], c['km_p'], c['km_a']]]}
            ).execute()
